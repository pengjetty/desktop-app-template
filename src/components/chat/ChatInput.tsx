...
export function ChatInput({ value, onChange, onSubmit, isProcessing }: ChatInputProps) {
    ...
    return (
        <TooltipProvider>
            <div className="w-full max-w-2xl mx-auto relative group/input">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 dark:from-blue-500/20 dark:via-purple-500/20 dark:to-pink-500/20 rounded-[24px] blur-xl opacity-0 group-hover/input:opacity-100 transition-opacity duration-500" />
